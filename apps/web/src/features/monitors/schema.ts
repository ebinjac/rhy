...
export const createMonitorSchema = z.object({
  name: z.string().trim().min(1, "Enter a monitor name.").max(255, "Use 255 characters or fewer."),
  slug: z
    .string()
    .trim()
    .min(1, "Enter a slug.")
  ...
  tags: z.array(z.string().trim().min(1).max(64)).max(20, "Use no more than 20 tags."),
